...
function displayPics(){
  ...
  // Because here we declare rando using let, and let give the variable a block scope, and the problem is when we use the rando in line 38 it's out of the scope where it's declare in line 33, here the compiler will not find any declaration for it.
